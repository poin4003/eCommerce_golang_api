...
func (q *Queries) FindUser(ctx context.Context, arg FindUserParams) ([]PreGoAccUserInfo9999, error) {
	rows, err := q.db.QueryContext(ctx, findUser, arg.UserAccount, arg.UserNickname)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
